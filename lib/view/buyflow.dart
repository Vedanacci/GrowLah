...
class BuyFlow extends StatefulWidget {
  BuyFlow({Key key}) : super(key: key);

  @override
  _BuyFlowScreenState createState() {
    return _BuyFlowScreenState();
  }
}

class _BuyFlowScreenState extends State<BuyFlow> {
                ...
                children: <Widget>[
                  ...
                  Padding(
                    padding: const EdgeInsets.only(
                        top: 40.0, right: 50.0, left: 50.0),
                    child: Center(
                      child: Text(
                        'Select the category type which you would like to know'
                        ' about through this app !',
                        style: TextStyle(
                          fontWeight: FontWeight.bold,
                          fontFamily: AppConfig.roboto,
                          color: Colors.green,
                            ...
                            child: Padding(
                              ...
                              child: Neumorphic(
                                ...
                                child: Container(
                                  ...
                                  child: Center(
                                    child: Text(onBoardsList[index].content),
                                  ),
                                ),
                              ),
                            ),
